          ...
          <div class="row">
            ...
            <div class="col-md-3 col-lg-3">
              <div class="apply-block imagine-block">
                ...
                <h4>IMAGINE</h4>
                <p>Teams work with community members to brainstorm points of intervention and solutions.</p>
              </div>
            </div>
            <div class="col-md-3 col-lg-3">
              <div class="apply-block do-block">
                ...
                <h4>DO</h4>
                <p>Teams develop and implement an action plan for authentic and lasting change.</p>
              </div>
            </div>
            <div class="col-md-3 col-lg-3">
