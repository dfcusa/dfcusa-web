          ...
          <div class="container">
            ...
            <div class="row w-100 mx-auto">
                ...
                <div class="col-lg-7 mt-4 text-left">
                    "The persistent achievement disparities across income levels and between white students and students of black and Hispanic heritage. School shutdowns could not only cause disproportionate learning losses for these students—compounding existing gaps... by 15 to 20 percent."
                        ...
                        <div class="col-md-4">
                            <div class="text-slider">
                                <div class="carousel-cell">
                                    ...
                                    <p class="pt-3 pb-4">
                                        Students listen to a podcast, highlighting a series of interviews about equity in education, and think about the topic critically by naming facts, asking questions, pulling quotes and making personal connections. 
                                    </p>
                                ...
                                <div class="carousel-cell">
                                    ...
                                    <p class="pt-3 pb-4">
                                        Students consider the symptoms and the underlying factors that continue to cause inequities in education in a root cause analysis exercise.  
                                    </p>
                                    <a class="btn btn-outline-light text-uppercase next" href="#">Next Step</a>
                                </div>
                                <div class="carousel-cell">
            ...
            <div class="in-action">
                ...
                <div class="video">
                    <div class="frame">
                        <iframe width="100%"
                                height="315"
                                src="https://www.youtube.com/embed/m4v4TTXwmTA"
                                frameborder="0"
...
<!--                <iframe width="100%"-->
<!--                        height="315"-->
<!--                        src="https://www.youtube.com/watch?v=m4v4TTXwmTA"-->
<!--                        frameborder="0"-->
<!--                        allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture"-->
<!--                        allowfullscreen></iframe>-->
<!--            </div>-->
