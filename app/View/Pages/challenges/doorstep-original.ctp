...
<head>
    ...
    <link href="/dfcusa-web/app/webroot/challenges/doorstep/css/style-original.css?version=1.1" rel="stylesheet">
    <link href="/dfcusa-web/app/webroot/challenges/doorstep/css/responsive-original.css" rel="stylesheet">
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="single-option-list">
                                        ...
                                        <div class="opt-icon">
                                            <img src="/dfcusa-web/app/webroot/challenges/doorstep/img/heart-icon.png" alt="">
                                        </div>
                                        <h2>Feel</h2>
                                ...
                                <div class="col-md-3">
                                    <div class="single-option-list">
                                        <div class="opt-icon">
                                            <img src="/dfcusa-web/app/webroot/challenges/doorstep/img/light-icon.png" alt="">
                                        </div>
                                        <h2>Imagine</h2>
                                        <p>Get creative</p>
                                    </div>
                                ...
                                <div class="col-md-3">
                                    <div class="single-option-list">
                                        <div class="opt-icon">
                                            <img src="/dfcusa-web/app/webroot/challenges/doorstep/img/do-icon.png" alt="">
                                        </div>
                                        <h2>Do</h2>
                                ...
                                <div class="col-md-3">
                                    <div class="single-option-list">
                                        <div class="opt-icon">
                                            <img src="/dfcusa-web/app/webroot/challenges/doorstep/img/share-icon.png" alt="">
                                        </div>
                                        <h2>Share</h2>
                                        <p>Tell your story</p>
                                    </div>
