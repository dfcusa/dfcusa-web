...
<head>
  ...
  <link rel="stylesheet" href="/dfcusa-web/app/webroot/css/modern/app.css">
    ...
    <link href="/dfcusa-web/app/webroot/challenges/doorstep/css/style.css?version=1.2" rel="stylesheet">
...
<body>
    ...
    <section class="video-area pt-5 pb-5">
      <div class="container">
          <div class="row">
              <div class="col-lg-6">
                  <iframe width="450" height="250" style="border-radius: 20px" src="https://www.youtube.com/embed/Nh3CVqCi82Y" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
              </div>
        ...
        <div class="container">
          <div class="row">
            <div class="col-lg-12">
              ...
              <script async src="https://walls.io/js/wallsio-widget-1.2.js" data-wallurl="https://walls.io/z3duf?nobackground=1&amp;theme=fluid&amp;show_header=0" data-title="#TheDoorstepChallenge" data-width="100%" data-height="500" data-lazyload="1"></script>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="footer-top-area">
       <img class="ds-logo" src="/dfcusa-web/app/webroot/challenges/doorstep/img/des-logo.png" alt="">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="section-title">
                    ...
                    <div class="subs-box">
                        <div class="row">
                            <div class="col-lg-3 d-flex align-items-center justify-content-center">
                                <img src="/dfcusa-web/app/webroot/challenges/doorstep/img/map-img.png" alt="">
                            </div>
                            <div class="col-lg-9">
                                <div class="subs-all">
    ...
    <script src="/dfcusa-web/app/webroot/challenges/doorstep/js/jquery.min.js"></script>
    <script src="/dfcusa-web/app/webroot/challenges/doorstep/js/Popper.js"></script>
    <script src="/dfcusa-web/app/webroot/challenges/doorstep/js/jquery.sticky.js"></script>
    <script src="/dfcusa-web/app/webroot/challenges/doorstep/js/jquery.meanmenu.js"></script>
    <script src="/dfcusa-web/app/webroot/challenges/doorstep/js/owl.carousel.min.js"></script>
    <script src="/dfcusa-web/app/webroot/challenges/doorstep/js/bootstrap.min.js"></script>


    <script src="/dfcusa-web/app/webroot/challenges/doorstep/js/main.js"></script>
