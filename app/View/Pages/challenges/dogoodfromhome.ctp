...
<head>
    ...
    <meta property="og:description" content="Small acts can make a big difference!" />

    <meta name="twitter:card" content="summary_large_image" />
    <meta name="twitter:site" content="@dfcusa">
    <meta name="twitter:creator" content="@dfcusa">
    <meta name="twitter:title" content="Calling all kids and teens to take the Challenge!" />
    ...
    <link href="/dfcusa-web/app/webroot/challenges/dogoodfromhome/css/bootstrap.min.css" rel="stylesheet">
    <link href="/dfcusa-web/app/webroot/challenges/dogoodfromhome/css/all.min.css" rel="stylesheet">
    <link href="/dfcusa-web/app/webroot/challenges/dogoodfromhome/css/fontawesome.css" rel="stylesheet">
...
<body>
    ...
    <div class="phone-embed">
        <iframe width="244" height="526"
                src="https://www.youtube.com/embed/Ga46Ka-vs1E?rel=0" frameborder="0"
    ...
    <div class="help-area">
        <div class="container">
            <div class="row mb-3">
                <div class="col-lg-12">
                    <div class="section-title">
                        <h2>Get started by picking a group you care about:</h2>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <img class="sp-2" src="/dfcusa-web/app/webroot/challenges/dogoodfromhome/img/sp-1.png" alt="">
                    <div class="help-slider owl-carousel avatar-group">
                        <div class="single-help-slider-blk avatar">
                            <div class="hlp-img">
                                <img src="/dfcusa-web/app/webroot/challenges/dogoodfromhome/img/avatars/sick.png" alt="">
                            </div>
                            <h3>The Sick</h3>
                        </div>
                        <div class="single-help-slider-blk avatar">
                            <div class="hlp-img">
                                <img src="/dfcusa-web/app/webroot/challenges/dogoodfromhome/img/avatars/parents.png" alt="">
                            </div>
                            <h3>Parents</h3>
                        </div>
                        <div class="single-help-slider-blk avatar">
                            <div class="hlp-img">
                                <img src="/dfcusa-web/app/webroot/challenges/dogoodfromhome/img/avatars/discriminated.png" alt="">
                            </div>
                            <h3>Experiencing Discrimination</h3>
                        </div>
                        <div class="single-help-slider-blk avatar">
                            <div class="hlp-img">
                                <img src="/dfcusa-web/app/webroot/challenges/dogoodfromhome/img/avatars/restaurant.png" alt="">
                            </div>
                            <h3>Service Workers</h3>
                        </div>
                        <div class="single-help-slider-blk avatar">
                            <div class="hlp-img">
                                <img src="/dfcusa-web/app/webroot/challenges/dogoodfromhome/img/avatars/seniors.png" alt="">
                            </div>
                            <h3>The Elderly</h3>
                        </div>
                        <div class="single-help-slider-blk avatar">
                            <div class="hlp-img">
                                <img src="/dfcusa-web/app/webroot/challenges/dogoodfromhome/img/avatars/delivery.png" alt="">
                            </div>
                            <h3>Delivery Drivers</h3>
                        </div>
                        <div class="single-help-slider-blk avatar">
                            <div class="hlp-img">
                                <img src="/dfcusa-web/app/webroot/challenges/dogoodfromhome/img/avatars/healthcare.png" alt="">
                            </div>
                            <h3>Healthcare Workers</h3>
                        </div>
                        <div class="single-help-slider-blk avatar">
                            <div class="hlp-img">
                                <img src="/dfcusa-web/app/webroot/challenges/dogoodfromhome/img/avatars/petowner.png" alt="">
                            </div>
                            <h3>Pet Owners</h3>
                        </div>
                        <div class="single-help-slider-blk avatar">
                            <div class="hlp-img">
                                <img src="/dfcusa-web/app/webroot/challenges/dogoodfromhome/img/avatars/unemployed.png" alt="">
                            </div>
                            <h3>The Recently Unemployed</h3>
                        </div>
                        <div class="single-help-slider-blk avatar">
                            <div class="hlp-img">
                                <img src="/dfcusa-web/app/webroot/challenges/dogoodfromhome/img/avatars/youths.png" alt="">
                            </div>
                            <h3>Other Kids</h3>
                        </div>
                    </div>
            ...
            <div class="row border-top pt-4">
              <div class="col-lg-12 text-center text-white">
                You can also hear a short podcast from people around the country who have been impacted.<br/>
                <button class="btn btn-success mx-auto show-podcast mt-3"><i class="fas fa-podcast"></i>&nbsp;&nbsp;Play Podcast (8 min.)</button>
                <br/>
    ...
    <div class="step-area">
        <div class="container">
            <div class="section-title">
                <h2><span>Then </span>#DoGoodFromHome</h2>
            </div>
            <div class="row single-row step-1">
                <div class="col-lg-5">
                    <div class="step-img-main">
                        <img class="br-1" src="/dfcusa-web/app/webroot/challenges/dogoodfromhome/img/br-1.png" alt="">
                        <img class="top-house" src="/dfcusa-web/app/webroot/challenges/dogoodfromhome/img/home-img.png" alt="" width="300">
                    </div>
                </div>
                <div class="col-lg-7">
                ...
                <div class="col-lg-7">
                    <div class="step-text-blk">
                        ...
                        <div class="do-list-wrp">
                            ...
                            <div class="do-list">
                                <img class="phone" src="/dfcusa-web/app/webroot/challenges/dogoodfromhome/img/call-img.png" alt="">
                                <a href="http://www.google.com/covid-19" target="_new" class="text-danger"><img class="cdc" src="/dfcusa-web/app/webroot/challenges/dogoodfromhome/img/cdc_logo.png" style="width: 50px" alt="">Follow your state<br/>and local guidelines.<br/>Learn more</a>.
                            </div>
                        </div>
            ...
            <div class="row single-row step-4">
                <div class="col-lg-11 mx-auto">
                    <img class="house" src="/dfcusa-web/app/webroot/challenges/dogoodfromhome/img/step-3.png" width="250" alt="">
                    <div class="step-text-blk" style="width: 100%">
                        ...
                        <div class="do-list-wrp tips-list hide">
                            <img class="tp-sc" src="/dfcusa-web/app/webroot/challenges/dogoodfromhome/img/social-icons.png" alt="">
                            <div class="do-list">
                                <h4>Tips for posting on social media</h4>
                                <ul>
                                    <li>Tell your story using the words Feel, Imagine, Do, Share.</li>
                                    <li>In your video, say: "I took #dogoodfromhome" and challenge your friends.</li>
                                </ul>
    ...
    <script src="/dfcusa-web/app/webroot/challenges/dogoodfromhome/js/jquery.min.js"></script>
    <script src="/dfcusa-web/app/webroot/challenges/dogoodfromhome/js/Popper.js"></script>
    <script src="/dfcusa-web/app/webroot/challenges/dogoodfromhome/js/jquery.sticky.js"></script>
