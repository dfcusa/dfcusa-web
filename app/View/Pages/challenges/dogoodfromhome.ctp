            ...
            <div class="row single-row step-1">
                <div class="col-lg-5">
                    <div class="step-img-main">
                        ...
                        <img src="/dfcusa-web/app/webroot/challenges/dogoodfromhome/img/home-img.png" alt="" width="300">
                    </div>
                </div>
                <div class="col-lg-7">
                    ...
                    <div class="step-text-blk">
                        ...
                        <div class="do-list-wrp">
                            ...
                            <div class="do-list">
                                ...
                                <a href="http://www.google.com/covid-19" target="_new" class="text-danger"><img class="cdc" src="/dfcusa-web/app/webroot/challenges/dogoodfromhome/img/cdc_logo.png" style="width: 50px" alt="">Follow your state<br/>and local guidelines.<br/>Learn more</a>.</a>
                            </div>
                        </div>
