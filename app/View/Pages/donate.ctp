<section class="inner-hero inside" style="background-image: url('/dfcusa-web/app/webroot/img/img_hedr_teachers.png'); background-size: 100%">
  ...
  <div class="container">
    <h4><span>Help send the winners of DFC 2018</br>to Taipei, Taiwan this December!</span></h4>
  </div>
</section>
...
<section class="page-content">
	<div class="container">
      ...
      <div class="col-sm-12 donate">
        ...
        <p>We are proud to announce the winners of DFC USA 2018 - catalyzed by local health issues in their school community, students from PS 135Q (The Bellaire School) in New York City used design thinking to address the root cause of healthy hygiene. As they learned more about the issues and brainstormed solutions, they were motivated to create change both in their community and internationally. See what these young change-makers did here. Watch their amazing story here. 
        <br/><br/>Each year, DFC hosts a global conference inviting student change makers from over 45+ countries to share their ideas for a better world, and to celebrate what it means to "be the change!" Teams submit projects that are evaluated by industry experts. Several student teams submit to the DFC Challenge, but only one is selected from EACH country to attend the global conference, this year, in Madrid Spain (Nov 2017). 
      ...
      <div class="col-sm-12 donate">
        <div class="progress" id="progressbar">
          <div class="progress-bar" role="progressbar" style="width: 90%" aria-valuenow="90" aria-valuemin="0" aria-valuemax="100">
            <div class="progress-label">We've raised $17,000 of our goal of $18,500!</div>
          </div>
        </div>

        <br/><br/>
        <a href="https://donorbox.org/support-design-for-change-2018-ambassador-team?amount=undefined" class="donate-button">Donate Now!</a>
        ...
        <h4>This trip is a once in a lifetime experience</h4>
        <p class="video-text">
          ...
          <br/><br/><br/>-- Wakan, previous DFC USA winner and Be The Change conference attendee
        </p>
