<section class="inner-hero inside professional-development one-line" style="background-image: url('/dfcusa-web/app/webroot/img/img_hedr_workshops.png'); background-size: 100%">
  <div class="container">
    <h4 class="one-line"><span>Workshops</span></h4>
  </div>
</section>
    ...
    <div class="row">
      <div class="col-sm-12">
        <table class="table">
          ...
          <tr>
            <td width="25%"><b>Goal:</b></td><td>Exposes educators to design thinking for social impact and the UN Global Goals</td>
          </tr>
          <tr>
            <td width="25%"><b>Adaptive:</b></td><td>Accounts for the needs and constraints of specific organizations or groups of educators</td>
          </tr>
          <tr>
