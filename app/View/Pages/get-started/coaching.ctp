  ...
  <div class="container">
    <div class="row">
      <div class="col-sm-12">
        ...
        <p>Coaching offers individual educators or entire organizations the ability to co-create a development plan for mastering the Design for Change methodology. With coaching, educators determine the frequency and types of learning experiences that will best support their students and lead to the desired outcomes. Coaching plans are a combination of in-person workshops or feedback sessions, virtual coaching calls, resource development, and other customized learning opportunities.</p>
        ...
        <div class="pathway-block educator-block">
          ...
          <div class="pathway-det">
            ...
            <p>Co-create a development plan with a DFC Certified coach to best meet desired outcomes for an individual class or your entire organization.</p>
          </div>
        </div>
    ...
    <div class="row">
      <div class="col-sm-12">
        <table class="table">
          ...
          <tr>
            <td width="25%"><b>Price:</b></td><td><a href="/pages/contact-us?ref=coaching">Contact us</a> to design a program that meets your needs</td>
          </tr>
        </table>
      </div>
    </div>
